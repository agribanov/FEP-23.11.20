class Tabset {
    ...
    onTitleClick(e) {
        // Узнать по кому кликнули и показать соответствующие элементы
    }

    hideAll() {
        // Простись по всем показаным элементам и скрыть каждый из них
    }

    hide(index) {
        // Спрятать нужные элементы для индекса
    }

    show(index) {
        // показать нужные элементы для индекса
    }
}
